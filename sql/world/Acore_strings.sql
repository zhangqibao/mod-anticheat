...
(30090, '|cffffff00[|cffff0000ANTICHEAT ALERT|r|cffffff00]:|r TELEPORT HACK USED WHLE DUELING|cFFFF8C00 %s|r vs |cFFFF8C00 %s|r.', NULL, NULL, NULL, NULL, NULL, '', '', NULL);
